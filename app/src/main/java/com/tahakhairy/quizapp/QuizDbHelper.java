...
import com.tahakhairy.quizapp.QuizContract.CategoriesTable;
import com.tahakhairy.quizapp.QuizContract.QuestionsTable;
...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        ...
        addQuestion(q1);
        Question q2 = new Question("Geography, Medium: A is correct",
                "A", "B", "C", 1,
                Question.DIFFICULTY_MEDIUM, Category.GEOGRAPHY);
        addQuestion(q2);
        Question q3 = new Question("Programming, Medium: A is correct",
                "A", "B", "C", 1,
                Question.DIFFICULTY_MEDIUM, Category.PROGRAMMING);
        addQuestion(q3);
        Question q4 = new Question("Programming, Hard: A is correct",
                "A", "B", "C", 1,
                Question.DIFFICULTY_HARD, Category.PROGRAMMING);
        addQuestion(q4);
        Question q5 = new Question("Math, Hard: A is correct",
                "A", "B", "C", 1,
                Question.DIFFICULTY_HARD, Category.MATH);
        addQuestion(q5);
        Question q6 = new Question("Geography, Hard: A is correct",
                "A", "B", "C", 1,
